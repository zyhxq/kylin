...
public class SCCreator extends AbstractApplication {
    ...
    //    private static final String D_STREAMING = "streaming/";
    ...
    private void run(String owner, String output, Collection<SinkTool> sinkToolSet) throws IOException {
        ...
        //        List<StreamingConfig> kylinStreamings = Lists.newArrayList();
        ...
        for (SinkTool sourceTool : sinkToolSet) {
            ...
            //            if (sourceTool instanceof StreamSinkTool) {
            //                kylinStreamings.addAll(generateKylinStreamingForSystemCube((StreamSinkTool) sourceTool));
            //            }
        }
        ...
        //        for (StreamingConfig streaming : kylinStreamings) {
        //            generateKylinStreamingFileForSystemCube(output, streaming);
        //        }
    }
    ...
    //    private List<StreamingConfig> generateKylinStreamingForSystemCube(StreamSinkTool sinkTool) {
    //        List<StreamingConfig> result = Lists.newLinkedList();
    //        result.add(StreamingCreator.generateKylinStreamingForMetricsQuery(config, sinkTool));
    //        result.add(StreamingCreator.generateKylinStreamingForMetricsQueryCube(config, sinkTool));
    //        result.add(StreamingCreator.generateKylinStreamingForMetricsQueryRPC(config, sinkTool));
    //        result.add(StreamingCreator.generateKylinStreamingForMetricsJob(config, sinkTool));
    //        result.add(StreamingCreator.generateKylinStreamingForMetricsJobException(config, sinkTool));
    //
    //        return result;
    //    }
    ...
    //    private void generateKylinStreamingFileForSystemCube(String output, StreamingConfig streamingConfig)
    //            throws IOException {
    //        saveSystemCubeMetadataToFile(output + D_STREAMING + streamingConfig.getName() + ".json", streamingConfig,
